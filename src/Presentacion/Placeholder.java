...
/**
 * La clase Placeholder de posición mostrará un mensaje sobre la parte superior
 * de un componente de texto cuando el documento del campo de texto está vacío. 
 * La propiedad Show se usa para determinar la visibilidad del mensaje.
 *
 * La fuente y el color de primer plano de la solicitud se establecerán de 
 * forma predeterminada en esas propiedades del componente de texto principal. 
 * Eres libre de cambiar las propiedades después construccion de clases.
 */
