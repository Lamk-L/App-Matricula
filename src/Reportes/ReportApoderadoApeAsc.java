 ...
 * @author Lamk
 */
public class ReportApoderadoApeAsc {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportApoderadoApeAsc.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Apoderados Ordenados - Apellido");
    }
}
