 ...
 * @author Lamk
 */
public class ReportRelacionMatricula_Curso {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionMatricula_Curso.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Matricula_Curso");
    }
}
