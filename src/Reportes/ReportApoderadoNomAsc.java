 ...
 * @author Lamk
 */
public class ReportApoderadoNomAsc {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportApoderadoNomAsc.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Apoderados Ordenados - Nombre");
    }
}
