 ...
 * @author Lamk
 */
public class ReportRelacionCurso {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionCurso.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Curso");
    }
}
