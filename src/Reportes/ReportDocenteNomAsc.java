 ...
 * @author Lamk
 */
public class ReportDocenteNomAsc {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportDocenteNomAsc.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Docentes Ordenados - Nombre");
    }
}
