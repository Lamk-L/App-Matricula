 ...
 * @author Lamk
 */
public class ReportRelacionAlumno {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionAlumno.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Alumno");
    }
}
