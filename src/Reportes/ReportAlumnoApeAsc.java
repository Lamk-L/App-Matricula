 ...
 * @author Lamk
 */
public class ReportAlumnoApeAsc {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportAlumnoApeAsc.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Alumnos Ordenados - Apellido");
    }
}
