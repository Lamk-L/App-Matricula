 ...
 * @author Lamk
 */
public class ReportRelacionMatricula {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionMatricula.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Matricula");
    }
}
