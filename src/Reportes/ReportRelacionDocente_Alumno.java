 ...
 * @author Lamk
 */
public class ReportRelacionDocente_Alumno {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionDocente_Alumno.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Docente_Alumno");
    }
}
