...
public class ReportApoderado {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportApoderado.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Apoderados");
    }
}
