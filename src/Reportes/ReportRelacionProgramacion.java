 ...
 * @author Lamk
 */
public class ReportRelacionProgramacion {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportRelacionProgramacion.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Relación Programación");
    }
}
