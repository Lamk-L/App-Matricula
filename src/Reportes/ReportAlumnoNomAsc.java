 ...
 * @author Lamk
 */
public class ReportAlumnoNomAsc {
    public void reportesPDF() throws IOException,JRException{
        ...
        JasperReport archivo = JasperCompileManager.compileReport(nombre+"/src/Reportes/ReportAlumnoNomAsc.jrxml");
        ...
        ver.setVisible(true);
        ver.setTitle("Reporte Alumnos Ordenados - Nombre");
    }
}
